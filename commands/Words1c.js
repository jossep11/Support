...
const Spanish_logic = require('./data_fuctions');
...
const [saludos, despedidas, recuperarID, recuperarClave, rated_Problema_Luancher, 
    ...
    rated_guiaphanton, rated_guia_zerk_azul ] = Spanish_logic(contentss);    
...
//Conseguir un mediador----------------------------------------------------------------------------------- 6
    ...
    .setThumbnail('https://wiki.srolatino-servers.com/wp-content/uploads/2019/12/logowiki-1.png')
    .setDescription("En el videojuego puede contactar a cualquiera de los siguientes GM's: \n[GM]Celes \n[GM]Nao \n[GM]Scream \n[GM]Servivenet")
    .setTimestamp()
    message.author.send(Embed);
}
